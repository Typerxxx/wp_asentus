...
<?php get_header(); ?>
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img class="img-responsive" src="<?php bloginfo('template_url') ?>/assets/img/1920x1080/01.jpg" alt="Slider Image">
                    <div class="container">
                ...
                <div class="item">
                    <img class="img-responsive" src="<?php bloginfo('template_url') ?>/assets/img/1920x1080/02.jpg" alt="Slider Image">
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
        ...
        <div class="content-lg container">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 sm-margin-b-50">
                    <div class="margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <img class="img-responsive" src="<?php bloginfo('template_url') ?>/assets/img/970x647/01.jpg" alt="Latest Products Image">
                        </div>
                    </div>
                ...
                <div class="col-sm-4 sm-margin-b-50">
                    <div class="margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <img class="img-responsive" src="<?php bloginfo('template_url') ?>/assets/img/970x647/02.jpg" alt="Latest Products Image">
                        </div>
                    </div>
                ...
                <div class="col-sm-4 sm-margin-b-50">
                    <div class="margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <img class="img-responsive" src="<?php bloginfo('template_url') ?>/assets/img/970x647/03.jpg" alt="Latest Products Image">
                        </div>
                    </div>
                ...
                <div class="swiper-slider swiper-clients">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img class="swiper-clients-img" src="<?php bloginfo('template_url') ?>/assets/img/clients/01.png" alt="Clients Logo">
                        </div>
                        <div class="swiper-slide">
                            <img class="swiper-clients-img" src="<?php bloginfo('template_url') ?>/assets/img/clients/02.png" alt="Clients Logo">
                        </div>
                        <div class="swiper-slide">
                            <img class="swiper-clients-img" src="<?php bloginfo('template_url') ?>/assets/img/clients/03.png" alt="Clients Logo">
                        </div>
                        <div class="swiper-slide">
                            <img class="swiper-clients-img" src="<?php bloginfo('template_url') ?>/assets/img/clients/04.png" alt="Clients Logo">
                        </div>
                        <div class="swiper-slide">
                            <img class="swiper-clients-img" src="<?php bloginfo('template_url') ?>/assets/img/clients/05.png" alt="Clients Logo">
                        </div>
                        <div class="swiper-slide">
                            <img class="swiper-clients-img" src="<?php bloginfo('template_url') ?>/assets/img/clients/06.png" alt="Clients Logo">
                        </div>
                    </div>
                    <!-- End Swiper Wrapper -->
                </div>
        ...
        <div class="promo-section overflow-h">
            ...
            <div class="promo-section-img-right">
                <img class="img-responsive" src="<?php bloginfo('template_url') ?>/assets/img/970x970/01.jpg" alt="Content Image">
            </div>
        </div>
        <!-- End Promo Section -->
